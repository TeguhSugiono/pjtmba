...
<div id="div_outcontainer" class="modal fade" tabindex="-1">
...
<script type = "text/javascript" >
    ...
    $('#div_outcontainer').on('shown.bs.modal', function () {
        $(".loading_proses_ajax_modal").hide();
    });
    $('#div_outcontainer').on('hidden.bs.modal', function() {
        $(".loading_proses_ajax_modal").hide();
    });

    $('#closemodal').click(function () {
        $('#div_outcontainer').modal('hide');
    });
    ...
    $('#submit').submit(function(e){
        ...
        var url = '<?php echo site_url('upload_out_pjt/proses_upload_outcontainer') ?>';
        var data = new FormData(this) ;
        var pesan = 'proses_upload_outcontainer Error...';
        ...
        submit_ajax_proses_spinner(url, data, pesan)
            .then(function (dataok) {
                ...
                //=================================================
                url1 = '<?php echo site_url('upload_out_pjt/simpan_outcontainer_temporary') ?>';
                data1 = {DataExcel:dataok.data} ;
                pesan1 = 'simpan_outcontainer_temporary Error...';
                $(".loading_proses_ajax_modal").show();
                multi_ajax_proses_spinner(url1, data1, pesan1).then(function (dataok1){
                    ...
                    //#############################################################################
                    url = '<?php echo site_url('upload_out_pjt/simpan_outcontainer') ?>';
                    data = {DataExcel:dataok.data} ;
                    pesan = 'simpan_outcontainer Error...';
                    $(".loading_proses_ajax_modal").show();
                    multi_ajax_proses_spinner(url, data, pesan).then(function (dataok){
                        ...
                        alert('Sukses Menyimpan Data Outcontainer...');
                        $('#div_outcontainer').modal('hide');
