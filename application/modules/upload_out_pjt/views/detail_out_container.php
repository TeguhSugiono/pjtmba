                ...
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-top: 1%"> 
                    <div class="panel panel-primary">
                        <div class="panel-heading ctrl-panel-heading">
                            Data Detail Out Container Upload
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        detcontainer = $('#detcontainer').DataTable({
            "ajax": {
                "url": "<?php echo site_url('upload_out_pjt/fetch_table_detail'); ?>",
                "type": "POST",
                "data": function(data) {
                    data.data_id_upload = data_id_upload ;
                },  
                "dataSrc": ""
            },
            "columns": [
